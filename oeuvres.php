...
$oeuvres = [
    ...
    [
        ...
        "description" => [
            "short" => "Anaisha Devi",
            "full" => "Sur cette oeuvre conceptuelle à la fois organique, minérale et liquide, Anaisha Devi nous transporte dans un nuage noir envoûtant. Un sombre tableau qui, par son verni éclatant, rayonne tel un marbre poli. Une oeuvre à la cohérence transcendantale, exécutée à la perfection",
        ],
        "image" => [
            "src" => "pawel-czerwinski-3.png",
    ...
    [
        ...
        "description" => [
            ...
            "full" => "Vivamus commodo non libero at hendrerit. In lacinia dui sit amet pellentesque iaculis. Donec at ultricies sem porttitor.",
        ],
        "image" => [
            "src" => "pawel-czerwinski.png",
            "alt" => "Chromatics",
        ],
    ],
    [
        ...
        "description" => [
            "short" => "Hamish McKee",
            "full" => "Integer in nisl posuere, pulvinar ex ac, tincidunt risus. Nullam vel lorem et leo dignissim accumsan. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempor, magna non consectetur dapibus, est libero iaculis lacus, eget semper turpis orci vitae felis. Fusce eget molestie.",
        ],
        "image" => [
            "src" => "jazmin-quaynor.png",
    ...
    [
        ...
        "description" => [
            ...
            "full" => "Nunc fermentum purus dapibus justo fermentum auctor. Maecenas non tincidunt leo. Morbi vitae iaculis sem. Donec quis scelerisque massa. Fusce quis accumsan diam, et interdum lectus. Suspendisse mattis pulvinar vehicula. Duis nisi.",
        ],
        "image" => [
            "src" => "steve-johnson-6.png",
    ...
    [
        ...
        "description" => [
            ...
            "full" => "Vivamus quis odio vel ligula feugiat facilisis. Donec eleifend pellentesque massa, ut malesuada est bibendum sit amet. Morbi tincidunt nec tellus vel ornare. Mauris dolor tellus, gravida eget euismod eu, viverra eget urna. Phasellus feugiat ipsum nec lorem accumsan, sed porta quam dictum massa nunc.",
        ],
        "image" => [
            "src" => "pawel-czerwinski-2.png",
            "alt" => "La marée rouge",
        ],
    ],
    [
    ...
    [
        ...
        "description" => [
            ...
            "full" => "Donec semper a massa quis congue. In malesuada lorem ligula, ut posuere magna pulvinar in. Proin vitae enim gravida, commodo odio.",
        ],
        "image" => [
            "src" => "orfeas-green.png",
    ...
    [
        ...
        "description" => [
            ...
            "full" => "Curabitur dui odio, porta vel tempor sed, consectetur vitae mi. Interdum et malesuada fames ac ante ipsum primis in faucibus. Orci varius natoque penatibus nec.",
        ],
        "image" => [
            "src" => "steve-johnson-3.png",
